...
def train(rank, world_size):
    ...
    if rank == 0:
        #tokenizer = BertTokenizerFast.from_pretrained("../../tokenizer/bpe-post", max_len=512)
    ...
    for epoch in range(EPOCH_NUM):
        ...
        for batch_idx, (input_id, mask, target_id) in enumerate(train_loader):
            ...
            if batch_idx % 8 == 7:
                ...
                if rank == 0:
                    batch_logger(model.module, writer, batch_idx, epoch * len(train_loader) + batch_idx, out.loss.item(), None)      
